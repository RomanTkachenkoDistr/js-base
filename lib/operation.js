  ...
  _createClass(Operation, null, {
    ...
    manageDebit: {
      value: function manageDebit(opts) {
        ...
        var manageDebitOP = new xdr.ManageDirectDebitOp(attributes);
        var opAttributes = {};
    ...
    debitPayment: {
      value: function debitPayment(opts) {
        ...
        if (!StrKey.isValidEd25519PublicKey(opts.creditor)) {
        ...
        var payment = new xdr.PaymentOp(paymentOP);
        attributes.payment = payment;
        var debitPayment = new xdr.DirectDebitPaymentOp(attributes);
        var opAttributes = {};
